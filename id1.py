# -*- coding: utf-8 -*-
"""
Created on Sun Jun  9 12:15:37 2019
...
import datetime
import qrcode
os.system("title ID CARD Generator by Puru kapoor")
...
img_with_border = ImageOps.expand(til,border=30,fill='black')

img_with_border.paste(im,(600,350))
img_with_border.save(name+'.png')
